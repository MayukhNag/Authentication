...
const signup = () =>{
    ...
    let signUpSuccessAlart = document.getElementById('signup-alart-success')
    // let signUpFailureAlart = document.getElementById('signup-alart-failure')
    ...
    signUpSuccessAlart.style.display = 'block' 
   ...
   const login = () =>{
    ...
    let loginSuccessAlart=document.getElementById('login-alart-success')
    let loginFailureAlart=document.getElementById('login-alart-failure')


   let currentUser =  DB_USERS.find(user => user.email === enteredEmail && user.password === enteredPassword)
   if(currentUser){
    loginSuccessAlart.style.display='block'
    loginFailureAlart.style.display='none'

   }else{
    loginFailureAlart.style.display='block'
    loginSuccessAlart.style.display='none'
